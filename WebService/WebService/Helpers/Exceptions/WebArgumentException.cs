...
namespace WebService.Helpers.Exceptions
{
    ...
    public class WebArgumentException : ArgumentException
    {
        ...
        public WebArgumentException(string message, string paramName, Exception innerException) : base(message,
        ...
        protected WebArgumentException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}