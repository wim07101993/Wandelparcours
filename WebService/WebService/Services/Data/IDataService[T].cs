...
namespace WebService.Services.Data
{
    ...
    {
        /// <summary>
        /// GetTs is supposed to return all the ts from the database. 
        /// <para/>
        ...
        /// <summary>
        /// CreateT is supposed to save the passed <see cref="T"/> to the database.
        /// <para/>
        ...
        /// <summary>
        /// RemoveT is supposed to remove the <see cref="T"/> with the given id from the database.
        /// </summary>
        ...
        /// <summary>
        /// UpdateT is supposed to update the <see cref="T"/> with the id of the given <see cref="T"/>.
        /// <para/>
